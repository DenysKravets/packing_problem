...
public class Product extends Box{
    ...
    public boolean intersectsWith(Product product) {
        ...
        int volume_x1 = product.getGlobal_x();
        int volume_x2 = product.getGlobal_x() + product.getSizeX();
        int volume_y1 = product.getGlobal_y();
        int volume_y2 = product.getGlobal_y() + product.getSizeY();
        int volume_z1 = product.getGlobal_z();
        int volume_z2 = product.getGlobal_z() + product.getSizeZ();
